	...
	<view class="s-page-wrapper is-100vh">
		<view class="is-33vh has-mgt-10">
			<view class="is-flex is-column is-justify-center  is-align-center is-height-100">
				<image src="/static/Simple-login/img/common/avatar.jpg" mode="aspectFit" class="logoimg"></image>
				<!--<image src="../../../../static/Simple-login/img/common/logo.jpg" mode="aspectFit" class="logoimg"></image>-->
				<!--<image src="/static/hot-0.png" mode="aspectFit" class="logoimg"></image>-->
                <!--<img src="../../../../static/Simple-login/img/common/logo.jpg" height="120" width="120"/>-->
                <!--<img src="/static/Simple-login/img/common/avatar.jpg" height="120" width="120"/>-->
                <!--<img src="/static/api.png" height="120" width="120"/>-->
            </view>
        </view>
		<view class="content">
